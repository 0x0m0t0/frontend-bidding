      ...
      {isSent ? (
        <form onSubmit={handleSubmit}>
          ...
          <div className="w-full max-w-md mx-auto flex pb-2">
            <button
              type="submit"
              className="flex w-full mt-5 h-10 px-3 py-2 text-sm inline-flex items-center justify-center px-4 py-2 text-sm font-medium tracking-wide bg-midnightblue text-mustard transition-colors duration-200 rounded-md hover:bg-mustard hover:text-midnightblue focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 focus:shadow-outline focus:outline-none"
            >
              Submit
            </button>
          </div>
